...
- Configure the output device in `config.ini` to match the name of your headphones or speakers as it appears in Settings
- Append `, Windows WASAPI` to the output device name (e.g. `Speakers, Windows WASAPI`)
